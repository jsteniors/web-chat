...
var toggleChat = function () {
    ...
    if(oculto) {
        ...
        jchat('.chat-header').off('click');
        jchat('.chat-header').css('cursor','default');
    }else {
        ...
        jchat('.chat-header').css('cursor','move');
        jchat('.chat-header').on('click', function () {
            toggleChat();
        });
    }
...
jchat(document).ready(function(){
   jchat('.chat-closer-icon').on('click', function () {
     toggleChat();
   });
});
